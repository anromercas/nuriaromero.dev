...
export const comercios: ServicePageData = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Depende sobre todo de que tu ficha de Google Business Profile esté completa (dirección, horario, categoría y fotos correctas), de que tu web tenga los datos estructurados que indican a Google qué vendes y desde dónde, y de tener reseñas recientes de clientes reales. Ya incluyo esa base en tu web desde el lanzamiento. Quien prefiera no estar pendiente de revisarlo mes a mes encuentra en https://nuriaromero.dev/seo-local-sevilla/ cómo planteo ese seguimiento para comercios de barrio.",
    },
    {
